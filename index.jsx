...
function Settings({ isConfigured }) {
  const [copied, setCopied] = useState(false);
  const sql = `CREATE TABLE prospects (
  id BIGSERIAL PRIMARY KEY,
  username TEXT, name TEXT, avatar TEXT,
  avatar_color TEXT, followers INTEGER,
  location TEXT, niche TEXT, bio TEXT,
  engagement_score INTEGER, business_score INTEGER,
  branding_score INTEGER, diaspora_score INTEGER,
  pitch_potential TEXT, status TEXT DEFAULT 'New',
